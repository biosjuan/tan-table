...
export const Table = () => {
  ...
  useEffect(() => {
    ...
    const firstColumn = firstHeaderGroup.headers[0];
    const updateColumnWidth = () => {
      const newWidth = firstColumn.getSize();
      console.log(newWidth);
    };

    updateColumnWidth(); // Initial width

    // Add a resize event listener to track changes in column width
